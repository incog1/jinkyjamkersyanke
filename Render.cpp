...
void Render::SetupFonts()
{
	...
	font.buildate = g_Surface->FontCreate();
	font.speclist = g_Surface->FontCreate();
	...
	g_Surface->SetFontGlyphSet(font.Defuse, "Tahoma", 11, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Guns, "Tahoma", 11, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Time, "Arial", 11, 700, 0, 0, FONTFLAG_DROPSHADOW );
	g_Surface->SetFontGlyphSet(font.DroppedGuns, "Tahoma", 10, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.watermark, "System Bold", 12, 700, 0, 0, FONTFLAG_OUTLINE);
	g_Surface->SetFontGlyphSet(font.buildate, "Terminal", 13, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.speclist, "Tahoma", 13, 800, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.LBY, "Tahoma", 24, 900, 0, 0, FONTFLAG_OUTLINE);
