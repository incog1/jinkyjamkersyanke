...
namespace hooks
{
    ...
    void initialize()
    {
		...
		//viewrender.setup(g_ViewRender);
		//viewrender.hook_index(9, scene_end);
		...
		//Was gonna try to hook scene end for those pFakeAngleChams but ended up giving up
		//modelrender.hook_index(9, scene_end);
